    ...
    <div class="box">
        ...
        <main class="main">
            <div style="margin-right:5%; margin-left:5%;">
                <!--  -->
                <div id="carouselExampleRide" class="carousel slide" data-bs-ride="true" style="width:1200px;margin-left:5.5%;">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="../../Img/img đồ án/800-200--800x200-3.png" alt="" style="width:1230px;height:300px;">
                            <!-- <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Second slide" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#666"></rect><text x="50%" y="50%" fill="#444" dy=".3em">Second slide</text></svg> -->
                        </div>
                        <div class="carousel-item">
                            <img src="../../Img/img đồ án/800x200-800x200-4.png" alt="" style="width:1230px;height:300px;">
                            <!-- <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Third slide" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#555"></rect><text x="50%" y="50%" fill="#333" dy=".3em">Third slide</text></svg> -->
                        </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleRide"
                        data-bs-slide="prev" style="background-color: #888686;width:50px;height:50px;border-radius:50% 50%; margin-top:9%;margin-left:2%;">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleRide"
                        data-bs-slide="next" style="background-color: #888686;width:50px;height:50px;border-radius:50% 50%; margin-top:9%;margin-right:2%;">
                ...
                <div
                    ...
                    <div style="height: 50px;width:100%;">
                        <div style="width:100%;">
                            <p>
                            <h4 style="margin-left:45px;margin-top:15px;font-size:30px;">Danh mục nổi bật</h4>
                            </p>
                        </div>
                    </div>
                    <div class="container">
                ...
                <div style="margin-top:3%;">
                    <div class="row gx-0" style="width:100%;margin-left:2%;">
                        <div class="col">
                ...
                <div style="height: 24px;text-align: center;margin-top:35px;">
                    <a href="" style="color:#eb5555; text-decoration:none;text-align: center;font-size:20px;">Xem thêm
                        &gt;&gt;</a>
                </div>
                <!--  -->
                <div style="margin-top:2%;">
                    ...
                    <div class="row">
                        <div class="col"><img src="../../Img/img đồ án/samsung-390x210.webp" alt=""
                                style="width:320px;height:140px;"></div>
                        <div class="col"><img src="../../Img/img đồ án/gd-online-th4-390x210.webp" alt=""
                                style="width:320px;height:140px;"></div>
                        <div class="col"><img src="../../Img/img đồ án/Dung-cu-GD-390x210.webp" alt=""
                                style="width:320px;height:140px;"></div>
                    </div>
                </div>
            </div>
        ...
        <!-- footer -->
        <footer class="footer">
            <div class="row gx-0" style="width:1200px;">
